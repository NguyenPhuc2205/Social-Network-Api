 ...
 * 
 * @description Schema for user creation operations.
 * 
 * @required name - User's display name (1-50 characters)
 * @required username - Unique username (3-50 characters, alphanumeric + underscore)
 * @required email - User's email address (valid format, unique)
 * @required password - Raw password (will be hashed before storage, 8-128 characters)
 */
